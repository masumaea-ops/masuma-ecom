            ...
            {displayProducts.map((product) => (
                ...
                <div className="p-8 flex-1 flex flex-col">
                    <div className="mb-6">
                        ...
                        <h3 className="text-sm font-bold text-masuma-dark leading-tight font-display group-hover:text-masuma-orange transition-colors line-clamp-2 h-12 uppercase tracking-tight">
                            {product.name}
                        </h3>
